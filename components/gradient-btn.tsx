...
const GetStarted = () => {
    return (
      <button className='relative inline-flex h-12 overflow-hidden rounded-xl p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50'>
        ...
        <span className='text-md inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-slate-950 px-4 py-2 font-medium text-white backdrop-blur-3xl'>
         <Link href={'/docs'}>
          Get Started
         </Link>
