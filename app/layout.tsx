...
export default function RootLayout({ children }: RootLayoutProps) {
  ...
  return (
    ...
    <html lang="en" suppressHydrationWarning className=" bg-white dark:bg-neutral-950 dark:bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.1),rgba(255,255,255,0))]">
